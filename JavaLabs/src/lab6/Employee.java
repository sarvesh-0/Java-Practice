package lab6;
/*
Consider the Employee class created in earlier lab session. Display the total number of employees using a static
method, totalEmployees(). Modify the Employee class to implement auto-generation of employeeId.
 */
public class Employee {
    ...
    public static void main(String[] args) {
		...
		Employee e2 = new Employee(16,"Aditya",450000,40000);
